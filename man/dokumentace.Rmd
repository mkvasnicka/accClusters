...
Nejdůležitější i\ výpočetně nejnáročnější část hledání nebezpečných úseků spočívá ve výpočtu síťové jádrové hustoty nehod pro každý *lixel* silniční sítě reprezentovaný jeho středem.

[@GelbRJournal; @GelbManual]


## Klastrů úseků s častými nebo nebezpečnými nehodami
