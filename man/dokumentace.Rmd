...
UNIT_COST_DEAD = 32
UNIT_COST_SERIOUS_INJURY = UNIT_COST_DEAD / 4
UNIT_COST_LIGHT_INJURY = UNIT_COST_DEAD / 32
UNIT_COST_MATERIAL = 1
UNIT_COST_CONST = 0
...
Pozor: Pokud `config.R` obsahuje výrazy (jako např.\ `UNIT_COST_SERIOUS_INJURY = UNIT_COST_DEAD / 4`), tyto výrazy jsou v\ profilu nahrazeny danou hodnotou. Pokud tedy `config.R` nastaví hodnoty jednotlivých typů následků dopravní nehody takto:
...
`UNIT_COST_SERIOUS_INJURY` hodnotu\ 8 (nikoli\ 4). Důvod je ten, že všechny parametry, které nejsou v\ profilu explicitně změněny, zdědí své hodnoty z\ nastavení `config.R`.
