...
Pokud není zadán žádný z\ parametrů `-m`, `-c`, ani `-k`, pak systém aktualizuje běžná data o nehodách.

Typicky tedy skript aktualizuje pouze běžná data potřebná pro vizualizaci vlastních nehod, ale ne klastry těchto nehod. Důvod je ten, že data o\ vlastních nehodách je vhodné mít ve vizualizačním softwaru k\ dispozici jen s\ minimálním zpožděním, zatímco klastry nehodových míst má smysl aktualizovat maximálně jednou ročně. Pokud se tedy mají aktualizovat i\ tato data, je třeba skript spustit s\ parametrem\ `-k`.
