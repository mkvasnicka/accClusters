...
Výpočet vyžaduje typicky cca 4,5\ GB operační paměti na jedno jádro (v\ některých krocích však 10\ GB). Větší počet jader se tedy může použít pouze v\ případě, že je k\ dispozici dostatečné množství dedikované operační paměti.
