---
title: "Mechanismus identifikace nebezpečných míst (klastrů nehod)"
subtitle: "TAČR CK01000049\\break Tvorba pokročilých nástrojů pro analýzu dopravních nehod pro Policii ČR"
...
- najdeme *lixely* s vysokou hodnotou NKDE
    - prahovou hodnotu určíme jako *x* promile nejhorších úseků
...
- Může se změnit i\ pořadí klastrů seřazených podle způsobené škody.
    - Nejhorší klastry pro dvě různá nastavení *x* a *n* mohou ležet úplně jinde.

\

Detekce klastrů nemá sloužit jako automat, ale má pomoci policistovi zaměřit pozornost na problematická místa.

- Policista by měl vyzkoušet různé pohledy na data (různá nastavení *x* a *n*).
- Pak by se měl dívat na mapu skutečných nehod.
- Přitom musí zohlednit svou expertní znalost svého okresu.
